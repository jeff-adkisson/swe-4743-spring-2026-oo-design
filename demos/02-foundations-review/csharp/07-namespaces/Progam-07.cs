...
namespace Demo.Main
{
    public class Program
    {
        ...
        {
            var initializer = new CollectionInitializer();
            var collectionPrinter = new CollectionPrinter();
            var readingPlanPrinter = new ReadingPlanPrinter();
            var shortReadsPrinter = new ShortReadsPrinter();
            var artifactsPrinter = new ArtifactsByCultureMaterialNamePrinter();

            var collection = initializer.InitializeCollection();

            collectionPrinter.PrintCollection(collection);

            readingPlanPrinter.PrintReadingPlan(collection);

            shortReadsPrinter.PrintShortReads(collection, maxMinutes: 240);

            artifactsPrinter.PrintArtifactsByCultureMaterialName(collection);
        }
    }

    // -----------------------------
    // Former: Program.InitializeCollection
    // -----------------------------
    public class CollectionInitializer
    {
        public List<Demo.Entities.ICollectionItem> InitializeCollection()
        {
    ...
    // -----------------------------
    // Former: Program.PrintCollection
    // -----------------------------
    public class CollectionPrinter
    {
        public void PrintCollection(IEnumerable<Demo.Entities.ICollectionItem> items)
        {
    ...
    // -----------------------------
    // Former: Program.PrintReadingPlan
    // -----------------------------
    public class ReadingPlanPrinter
    {
        public void PrintReadingPlan(IEnumerable<Demo.Entities.ICollectionItem> items)
        {
    ...
    // -----------------------------
    // Former: Program.PrintShortReads
    // -----------------------------
    public class ShortReadsPrinter
    {
        public void PrintShortReads(IEnumerable<Demo.Entities.ICollectionItem> items, int maxMinutes)
        {
    ...
    // -----------------------------
    // Former: Program.PrintArtifactsByCultureMaterialName
    // -----------------------------
    public class ArtifactsByCultureMaterialNamePrinter
    {
        public void PrintArtifactsByCultureMaterialName(IEnumerable<Demo.Entities.ICollectionItem> items)
        {
            var artifacts =
