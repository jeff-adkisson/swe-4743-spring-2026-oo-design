...
export class HeatIndexComponent implements OnInit, OnDestroy {
  heatIndex = 0;
  ...
  ngOnInit(): void {
    ...
    this.weatherService.registerSubscriber('HeatIndexDisplay');
  }

  ngOnDestroy(): void {
    this.subscription.unsubscribe();
    this.weatherService.unregisterSubscriber('HeatIndexDisplay');
  }
