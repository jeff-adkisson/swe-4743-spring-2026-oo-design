...
classDiagram
    ...
    StateStartOfWord ..> CharacterMatch : uses
    StateCaptureName ..> CharacterMatch : uses
    StateCaptureDomain ..> CharacterMatch : uses
    StateCaptureTopLevelDomain ..> CharacterMatch : uses
    StateAdvanceToNextWord ..> CharacterMatch : uses
```
